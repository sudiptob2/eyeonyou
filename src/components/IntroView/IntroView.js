        ...
        <div className="introView container">
            {!clicked && (
                <div>
                    <div
                        style={{}}
                        className="logo row justify-content-center p-2"
                    >
                        <Logo />
                    </div>
                    ...
                    <div className="row justify-content-center subtitle-custom-padding">
                        <p className="subTitleText">
                            virtual coworking with eyeonyou significantly
                    ...
                    <div className="infoText text-center row justify-content-center p-2">
                        <p className="textDetails">
                            Built with TensorFlow.js + p5.js + React.js. Learn
                            more about{" "}
                            <a
                                className="link"
                                href="https://github.io/sudiptob2"
                            >
                                how it works.
                            </a>
                        </p>
